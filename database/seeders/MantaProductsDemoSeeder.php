...
namespace Manta\Products\Database\Seeders;

use Illuminate\Database\Seeder;
use Illuminate\Support\Arr;
use Manta\Products\Models\{Product, Attribute, AttributeValue, ProductVariant, ProductVariantValue, ProductAttribute, Room, PriceRule, OpeningHour};
