                ...
                <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
                    <div class="lg:col-span-2">
                        <flux:card class="space-y-6">
                            ...
                            <div class="text-center py-8 text-gray-500">
                                ...
                                <p class="text-lg font-medium mb-2">Nog geen varianten</p>
                                <p class="text-sm">Varianten kunnen worden toegevoegd nadat het product is opgeslagen.</p>
                            </div>
                        </flux:card>
                    </div>
                    ...
                    <div class="space-y-6">
                        <flux:card class="space-y-4">
                            ...
                            <div class="text-sm text-gray-600">
                                <p>Varianten maken het mogelijk om verschillende versies van hetzelfde product te hebben met verschillende eigenschappen zoals kleur, maat, of andere attributen.</p>
                            </div>
                        </flux:card>
