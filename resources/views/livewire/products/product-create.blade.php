<flux:main container>
    ...
    <div class="mb-8 mt-4 flex items-center justify-between">
        <div>
            <flux:heading size="xl">Product toevoegen</flux:heading>
        </div>
                        ...
                        <flux:card class="space-y-6">
                            ...
                            @if ($this->fields['slug']['active'])
                                <flux:field>
                                    ...
                                    <flux:description>
                                        URL-vriendelijke versie van de titel (wordt automatisch gegenereerd)
                                    </flux:description>
                            ...
                            <flux:field>
                                ...
                                <flux:textarea wire:model="excerpt" placeholder="Korte samenvatting van het product..." rows="3" />
                            ...
                            <flux:field>
                                ...
                                <flux:textarea wire:model="description" placeholder="Uitgebreide beschrijving van het product..." rows="5" />
                                <flux:error name="description" />
                            </flux:field>

                            <!-- Beschrijving 2 -->
                            <flux:field>
                                <flux:label>Beschrijving 2</flux:label>
                                <flux:textarea wire:model="description_2" placeholder="Optionele tweede beschrijving..." rows="5" />
                                <flux:error name="description_2" />
                            </flux:field>

                            <!-- Beschrijving 3 -->
                            <flux:field>
                                <flux:label>Beschrijving 3</flux:label>
                                <flux:textarea wire:model="description_3" placeholder="Optionele derde beschrijving..." rows="5" />
                                <flux:error name="description_3" />
                            </flux:field>

                            <!-- Opmerkingen -->
                            <flux:field>
                                <flux:label>Opmerkingen</flux:label>
                                <flux:textarea wire:model="comments" placeholder="Interne opmerkingen..." rows="3" />
                                <flux:description>
                        ...
                        <flux:card class="space-y-4">
                            ...
                            <flux:file-upload wire:model="files" multiple label="Upload bestanden">
                                <flux:file-upload.dropzone 
                                    heading="Sleep bestanden of klik om te bladeren"
                                    text="JPG, PNG, PDF tot 10MB"
                                    inline
                                />
                            </flux:file-upload>
                                ...
                                <div class="mt-4 flex flex-col gap-2">
                                    @foreach ($existingUploads as $upload)
                                        @php
                                            ...
                                            $imageData = $uploadModel && $uploadModel->image ? $uploadModel->getImage(200) : null;
                                            $imageUrl = $imageData && isset($imageData['url']) ? $imageData['url'] : '';
                                        @endphp
                                        <flux:file-item
                                        ...
                                        >
                                            <x-slot name="actions">
                                                <flux:file-item.remove wire:click="removeUpload({{ $upload['id'] }})" />
                                            </x-slot>
                                        </flux:file-item>
                                    @endforeach
                                </div>
                        ...
                        <flux:card class="space-y-6">
                            ...
                            @if ($this->fields['tax_rate']['active'])
                                <flux:field>
                                    ...
                                    <flux:input type="number" step="0.01" wire:model="tax_rate" placeholder="21.00"
                    ...
                    <div class="lg:col-span-2">
                        <flux:card class="space-y-6">
                            <div class="flex items-center justify-between">
                                ...
                                <div class="text-sm text-gray-600">
                                    {{ count($selectedCategories) }} van {{ count($availableCategories) }} geselecteerd
                                </div>
                            </div>
                ...
                <div class="grid grid-cols-1 gap-8 lg:grid-cols-3">
                    <div class="lg:col-span-2">
                        <flux:card class="space-y-6">
                            ...
                            @if($item && count($variants) > 0)
                                <div class="space-y-4">
                                    @foreach ($variants as $variant)
                                        <div class="{{ $variant['active'] ? 'bg-green-50 border-green-200' : 'bg-gray-50 border-gray-200' }} rounded-lg border p-4">
                            ...
                            @else
                                <div class="py-8 text-center text-gray-500">
                                    ...
                                    <p class="mb-2 text-lg font-medium">Nog geen varianten</p>
                                    <p class="text-sm">
                                        @if($item)
                                            Klik op "Variant toevoegen" om de eerste variant aan te maken.
                                        @else
                                            Varianten kunnen worden toegevoegd nadat het product is opgeslagen.
                                        @endif
                                    </p>
                                </div>
                            @endif
                    ...
                    <div class="space-y-6">
                        <flux:card class="space-y-4">
                            <flux:heading size="lg">Info</flux:heading>
                            <div class="text-sm text-gray-600">
                                <p>Varianten maken het mogelijk om verschillende versies van hetzelfde product te hebben
                                    met verschillende eigenschappen zoals kleur, maat, of andere attributen.</p>
                            </div>
                        </flux:card>
